...
function IssueDetail ({ issue }) {
    return <div className="root">
        ...
        <div className="actions">
            <Button href={issue.html_url} target="_blank">打開 Issue 討論頁面</Button>
        </div>
        <style jsx>
            {`
                .root {
        ...
        <div>
            <div className="issue">
                ...
                <div className="avatar">
                    <Avatar src={issue.user.avatar_url} shpae="square" size={50} />
                </div>
...
function Label({ label }) {
    return (
        <>
            <sapn className="label" style={{ backgroundColor: `#${label.color}` }}>{label.name}</sapn>
            <style jsx>{`
                .label {
                    display: inline-block;
                    line-height: 20px;
    ...
    return (
        <div className="root">
            <div className="search">
                ...
                <Select placeholder="狀態" onChange={handleStateChange} style={{ width: 200, marginLeft: 20 }} value={state}>
                ...
                <Button type="primary" disabled={fetching} onClick={handleSearch}>搜尋</Button>
            </div>
            {
